...
def load_periods():
    ...
    periods = [
        ...
        (2026,  1, date(2026, 3, 25), date(2026, 4,  5), 12, "regular"),
        (2026,  2, date(2026, 4,  6), date(2026, 4, 12),  7, "regular"),
        (2026,  3, date(2026, 4, 13), date(2026, 4, 19),  7, "regular"),
        (2026,  4, date(2026, 4, 20), date(2026, 4, 26),  7, "regular"),
        (2026,  5, date(2026, 4, 27), date(2026, 5,  3),  7, "regular"),
        (2026,  6, date(2026, 5,  4), date(2026, 5, 10),  7, "regular"),
        (2026,  7, date(2026, 5, 11), date(2026, 5, 17),  7, "regular"),
        (2026,  8, date(2026, 5, 18), date(2026, 5, 24),  7, "regular"),
        (2026,  9, date(2026, 5, 25), date(2026, 5, 31),  7, "regular"),
        (2026, 10, date(2026, 6,  1), date(2026, 6,  7),  7, "regular"),
        (2026, 11, date(2026, 6,  8), date(2026, 6, 14),  7, "regular"),
        (2026, 12, date(2026, 6, 15), date(2026, 6, 21),  7, "regular"),
        (2026, 13, date(2026, 6, 22), date(2026, 6, 28),  7, "regular"),
        (2026, 14, date(2026, 6, 29), date(2026, 7,  5),  7, "regular"),
        (2026, 15, date(2026, 7,  6), date(2026, 7, 12),  7, "regular"),
        (2026, 16, date(2026, 7, 13), date(2026, 7, 26), 14, "regular"),
        (2026, 17, date(2026, 7, 27), date(2026, 8,  2),  7, "playoff"),
        (2026, 18, date(2026, 8,  3), date(2026, 8,  9),  7, "playoff"),
        (2026, 19, date(2026, 8, 10), date(2026, 8, 16),  7, "playoff"),
        (2026, 20, date(2026, 8, 17), date(2026, 8, 23),  7, "playoff"),
        (2026, 21, date(2026, 8, 24), date(2026, 8, 30),  7, "playoff"),
        (2026, 22, date(2026, 8, 31), date(2026, 9,  6),  7, "playoff"),
        (2026, 23, date(2026, 9,  7), date(2026, 9, 13),  7, "playoff"),
        (2026, 24, date(2026, 9, 14), date(2026, 9, 20),  7, "playoff"),
        (2026, 25, date(2026, 9, 21), date(2026, 9, 27),  7, "playoff"),
    ]
